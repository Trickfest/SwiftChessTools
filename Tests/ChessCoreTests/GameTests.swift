...
@Test func positionCounts() {
    ...
    game.apply(move: "b8a8")
    game.apply(move: "g4f3")
    game.apply(move: "a8b8")
    game.apply(move: "f3g4")
...
@Test func enPassantCapture() {
    ...
    game.apply(move: "d2c3")
    game.apply(move: "f7f5")
    game.apply(move: "g5f6")
...
@Test func isCheckmate() {
    let fenSerializer = FENSerializer()
    let matePosition = fenSerializer.position(
    ...
    let stalematePosition = fenSerializer.position(
