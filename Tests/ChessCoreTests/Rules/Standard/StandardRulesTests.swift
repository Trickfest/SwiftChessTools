...
@Test(
    ...
    arguments: [
        // Rook moves.
        ("8/8/8/3R4/8/8/8/8 w - - 0 1", "a5 b5 c5 e5 f5 g5 h5 d1 d2 d3 d4 d6 d7 d8", "d5"),  // Center board.
        ("7R/8/8/8/8/8/8/8 w - - 0 1", "a8 b8 c8 d8 e8 f8 g8 h1 h2 h3 h4 h5 h6 h7", "h8"),  // Corner.
        ("8/3P4/8/3RP3/8/8/3N4/8 w - - 0 1", "a5 b5 c5 d3 d4 d6", "d5"),  // Friendly blockers.
        ("8/3p4/8/3Rp3/8/8/3n4/8 w - - 0 1", "a5 b5 c5 e5 d2 d3 d4 d6 d7", "d5"),  // Captures.

        // Bishop moves.
        ("8/8/8/4b3/8/8/8/8 b - - 0 1", "a1 b2 c3 d4 f6 g7 h8 b8 c7 d6 f4 g3 h2", "e5"),  // Center board.
        ("7b/8/8/8/8/8/8/8 b - - 0 1", "a1 b2 c3 d4 e5 f6 g7", "h8"),  // Corner.
        ("8/1k6/8/3b4/2r5/8/8/7p b - - 0 1", "e6 f7 g8 c6 e4 f3 g2", "d5"),  // Friendly blockers.
        ("8/1Q6/8/3b4/2R5/8/6P1/8 b - - 0 1", "c4 e6 f7 g8 b7 c6 e4 f3 g2", "d5"),  // Captures.
        ...
        ("K7/8/8/8/8/8/8/8 w - - 0 1", "a7 b7 b8", "a8"),  // Top-left corner.
        ("7K/8/8/8/8/8/8/8 w - - 0 1", "g8 g7 h7", "h8"),  // Top-right corner.
        ("8/8/8/8/8/8/8/7K w - - 0 1", "g1 g2 h2", "h1"),  // Bottom-right corner.
        ("8/8/8/8/8/8/8/K7 w - - 0 1", "a2 b2 b1", "a1"),  // Bottom-left corner.
        ("8/8/8/3PPP2/3PKP2/3PPP2/8/8 w - - 0 1", "", "e4"),  // Fully blocked by friendly pieces.
        ("8/8/8/3PP3/3PK3/3P1P2/8/8 w - - 0 1", "f5 f4 e3", "e4"),  // Partially blocked by friendly pieces.
        ("8/8/8/3r4/4K3/8/8/8 w - - 0 1", "e3 f3 f4 d5", "e4"),  // Captures.
        ("8/8/3k4/8/4K3/8/8/8 w - - 0 1", "f5 f4 f3 e3 d3 d4", "e4"),  // Opposing king controls adjacent squares.
        ("8/8/3k4/8/3K4/8/8/8 w - - 0 1", "c4 c3 d3 e3 e4", "d4"),
        ("8/8/3k4/8/5K2/8/8/8 w - - 0 1", "f5 g5 g4 g3 f3 e3 e4", "f4"),
        ("r1bqkbnr/pppp1ppp/2n5/8/3pP3/5N2/PPP2PPP/RNBQKB1R w KQkq - 0 4", "d2 e2", "e1"),  // Kingside castling blocked.
        ...
        ("r1b1kbnr/ppp1qppp/2np4/4p3/3PP3/2N5/PPP1QPPP/R1B1KBNR w KQkq - 4 5", "d1 d2", "e1"),  // Queenside castling blocked.
        ...
        ("3kr3/8/8/8/8/8/8/R3K2R w KQ - 0 1", "d1 d2 f1 f2", "e1"),  // Castling while in check is illegal.
        ("3rkr2/8/8/8/8/8/8/R3K2R w KQ - 0 1", "e2", "e1"),  // Castling through check is illegal.
...
@Test(
    ...
    arguments: [
        // Check evasions.
        ("8/8/8/3q4/4K3/8/8/8 w - - 0 1", "e4d5 e4f4 e4e3"),  // Queen check.
        ("8/8/8/3r4/4K3/8/8/8 w - - 0 1", "e4d5 e4f4 e4f3 e4e3"),  // Rook check.
        ("8/8/8/3b4/4K3/8/8/8 w - - 0 1", "e4d5 e4e5 e4f5 e4f4 e4e3 e4d3 e4d4"),  // Bishop check.
        ("8/8/8/3n4/4K3/8/8/8 w - - 0 1", "e4d5 e4e5 e4f5 e4f3 e4d3 e4d4"),  // Knight check.
        ("8/8/3p4/8/3K4/8/8/8 w - - 0 1", "d4d5 d4e4 d4e3 d4d3 d4c3 d4c4"),  // Pawn check.
