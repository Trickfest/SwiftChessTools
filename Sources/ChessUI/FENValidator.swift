...
public class FENValidator {
    ...
    private static func isValidPiecePlacement(_ placement: String) -> Bool {
    ...
    private static func isValidCastlingAvailability(_ castling: String) -> Bool {
        if castling == "-" {
            return true
        }
    ...
    private static func isValidEnPassantSquare(_ square: String, activeColor: String) -> Bool {
        if square == "-" {
            return true
        }
